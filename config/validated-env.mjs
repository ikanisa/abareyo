...
const envSchema = z.object({
  ...
  BACKEND_SENTRY_DSN_STAGING: z.string().optional(),
  BACKEND_SENTRY_DSN_PRODUCTION: z.string().optional(),
...
const serverEnv = {
  ...
  BACKEND_SENTRY_DSN: parsed.BACKEND_SENTRY_DSN,
  BACKEND_SENTRY_DSN_STAGING: parsed.BACKEND_SENTRY_DSN_STAGING,
  BACKEND_SENTRY_DSN_PRODUCTION: parsed.BACKEND_SENTRY_DSN_PRODUCTION,
