...
export const GET = async (request: Request, context: { params: { matchId: string } }) => {
  ...
  try {
    ...
    console.error('admin.match-ops.match.fetch_failed', error);
    return NextResponse.json({ message: 'Failed to load match' }, { status: 500 });
  }
};
...
export const PATCH = async (request: Request, context: { params: { matchId: string } }) => {
  ...
  try {
    ...
    console.error('admin.match-ops.match.update_failed', error);
...
export const DELETE = async (request: Request, context: { params: { matchId: string } }) => {
  ...
  try {
    ...
    console.error('admin.match-ops.match.delete_failed', error);
