...
const QuoteSummary = ({ plate, motoType, period, partnerId, onClose, onBack }: Props) => {
  ...
  return (
    <section className="card break-words whitespace-normal break-words whitespace-normal space-y-4" aria-label="Quote summary">
      ...
      <div className="card break-words whitespace-normal break-words whitespace-normal bg-white/5">
