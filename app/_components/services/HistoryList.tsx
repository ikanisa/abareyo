  ...
  return (
    <section className="space-y-3" aria-label="My Services history">
      ...
      <div className="grid gap-3 md:grid-cols-2">
        <div className="card break-words whitespace-normal break-words whitespace-normal space-y-2" aria-live="polite">
      ...
      <div className="card break-words whitespace-normal break-words whitespace-normal text-sm text-white/70" role="note">
        {latestPolicyNumber ? (
          <p>
