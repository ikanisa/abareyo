...
function Skeleton() {
  return (
    <div className="card break-words whitespace-normal break-words whitespace-normal" aria-busy="true" aria-label="Loading rewards">
...
export default function RewardsWidget({ userId }: { userId?: string }) {
  ...
  if (!data) {
    return (
      <div className="card break-words whitespace-normal break-words whitespace-normal" aria-live="polite">
  ...
  return (
    <section className="card break-words whitespace-normal break-words whitespace-normal" aria-label="Rewards widget" aria-live="polite">
